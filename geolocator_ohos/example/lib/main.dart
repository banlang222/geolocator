...
class _GeolocatorWidgetState extends State<GeolocatorWidget> {
  ...
  final GeolocatorPlatform geolocatorOhos = GeolocatorPlatform.instance;
            ...
            (context) => Scaffold(
              ...
              floatingActionButton: Column(
                ...
                children: [
                  ...
                  if (_positionStreamSubscription != null) sizedBox,
  ...
  Color _determineButtonColor() {
    return _isListening() ? Colors.amber : Colors.green;
  }
  ...
  Future<void> _toggleListening() async {
    ...
    if (_positionStreamSubscription == null) {
      ...
      final positionStream =
          geolocatorOhos.getPositionStream(locationSettings: ohosSettings);
