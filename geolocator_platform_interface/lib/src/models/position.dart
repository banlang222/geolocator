...
class Position {
  ...
  static Position fromMap(dynamic message) {
    ...
    return Position(
      latitude: (positionMap['latitude'] as num?)?.toDouble() ?? 0.0,
      longitude: (positionMap['longitude'] as num?)?.toDouble() ?? 0.0,
      timestamp: timestamp,
      altitude: (positionMap['altitude'] as num?)?.toDouble() ?? 0.0,
      altitudeAccuracy: (positionMap['altitude_accuracy'] as num?)?.toDouble() ?? 0.0,
      accuracy: (positionMap['accuracy'] as num?)?.toDouble() ?? 0.0,
      heading: (positionMap['heading'] as num?)?.toDouble() ?? 0.0,
      headingAccuracy: (positionMap['heading_accuracy'] as num?)?.toDouble() ?? 0.0,
      floor: positionMap['floor'],
      speed: (positionMap['speed'] as num?)?.toDouble() ?? 0.0,
      speedAccuracy: (positionMap['speed_accuracy'] as num?)?.toDouble() ?? 0.0,
